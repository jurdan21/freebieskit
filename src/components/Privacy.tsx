  ...
  return (
    <section className="max-w-2xl mx-auto px-4 py-16 text-black font-inter">
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold mb-2 text-gray-700">1. What We Collect</h2>
        <p className="mb-2">We only collect what we need to make the site better:</p>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold mb-2 text-gray-700">2. How We Use It</h2>
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold mb-2 text-gray-700">3. Cookies</h2>
        <p className="mb-2">Yes, we use cookies — the digital kind, not the chocolate chip ones:</p>
        <ul className="list-disc pl-6 mb-2">
      ...
      <section className="mb-6">
        <h2 className="text-lg font-semibold mb-2 text-gray-700">4. External Links</h2>
        <p className="mb-2">Some assets link to third-party platforms like Figma, GitHub, or Dribbble. Once you leave Freebieskit, we can’t control how those sites handle your data — so please read their policies too.</p>
      </section>
      <section className="mb-6">
        <h2 className="text-lg font-semibold mb-2 text-gray-700">5. Your Rights</h2>
        <p className="mb-2">You’re in control. You can:</p>
        <ul className="list-disc pl-6 mb-2">
        ...
        <p className="mb-2">Just email us at <a href="mailto:hello@freebieskit.com" className="text-blue-600 underline">hello@freebieskit.com</a> and we’ll help you out.</p>
      </section>
    </section>
  );
} 