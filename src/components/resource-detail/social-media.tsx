...
export default function DetailSocialMedia({ id }: { id: string }) {
  ...
  useEffect(() => {
    async function fetchResource() {
      setLoading(true);
      setError(null);
      // Ambil id kategori social-media
  ...
  return (
    <div className="max-w-3xl mx-auto py-16 px-4">
      <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Social Media", href: "/?tab=social-media#resource-section" }, { label: resource.title }]} />
      <script
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Social Media",
                "item": "https://freebieskit.com/?tab=social-media#resource-section"
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": resource.title,
                "item": `https://freebieskit.com/resource/social-media/${resource.id}`
              }
            ]
          })
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": `https://freebieskit.com/resource/social-media/${resource.id}`,
            "author": {
              "@type": "Organization",
              "name": "Freebieskit"
            }
