...
export default function DetailIllustrations({ id }: { id: string }) {
  ...
  useEffect(() => {
    async function fetchResource() {
      setLoading(true);
      setError(null);
      // Ambil id kategori illustrations
  ...
  return (
    <div className="max-w-3xl mx-auto py-16 px-4">
      <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Illustrations", href: "/?tab=illustrations#resource-section" }, { label: resource.title }]} />
      <script
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "position": 2,
                "name": "Illustrations",
                "item": "https://freebieskit.com/?tab=illustrations#resource-section"
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": resource.title,
                "item": `https://freebieskit.com/resource/illustrations/${resource.id}`
              }
            ]
          })
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": `https://freebieskit.com/resource/illustrations/${resource.id}`,
            "author": {
              "@type": "Organization",
              "name": "Freebieskit"
            }
