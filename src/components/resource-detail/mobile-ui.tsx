...
const resources = [
  {
    ...
    overview: "Complete mobile app UI kit with 100+ screens, components, and design system. Perfect for iOS and Android app development.",
    category: "Mobile UI Kit",
    compatibility: "Figma, Sketch",
  },
  {
    id: 2,
    title: "iOS App Template",
    author: "MobileDesigner",
    platform: "Figma",
    image: "https://res.cloudinary.com/doihq9rxd/image/upload/v1752339647/img5_uadbh2.webp",
    overview: "Modern iOS app template with native design patterns, dark mode support, and comprehensive component library.",
    category: "Mobile UI Kit",
    compatibility: "Figma",
  },
...
export default function DetailMobileUI({ id }: { id: string }) {
  ...
  return (
    <div className="max-w-3xl mx-auto py-16 px-4">
      <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Mobile UI Kit", href: "/resource/mobile-ui-kit" }, { label: resource.title }]} />
      ...
      <a href="#" className="inline-block px-5 sm:px-6 py-2 rounded-full bg-blue-600 text-white font-medium shadow hover:bg-blue-700 transition text-sm sm:text-base">Download Now</a>
    </div>
  );
} 