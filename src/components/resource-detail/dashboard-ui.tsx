...
export default function DetailDashboardUI({ id }: { id: string }) {
  ...
  useEffect(() => {
    async function fetchResource() {
      setLoading(true);
      setError(null);
      // Ambil id kategori dashboard-ui-kit
  ...
  return (
    <div className="max-w-3xl mx-auto py-16 px-4">
      <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Dashboard UI Kit", href: "/?tab=dashboard-ui-kit#resource-section" }, { label: resource.title }]} />
      <script
          ...
          __html: JSON.stringify({
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://freebieskit.com/?tab=dashboard-ui-kit#resource-section"
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": resource.title,
                "item": `https://freebieskit.com/resource/dashboard-ui-kit/${resource.id}`
              }
            ]
          })
        }}
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": `https://freebieskit.com/resource/dashboard-ui-kit/${resource.id}`,
            "author": {
              "@type": "Organization",
              "name": "Freebieskit"
            }
