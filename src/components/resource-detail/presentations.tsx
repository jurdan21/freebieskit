...
export default function DetailPresentations({ id }: { id: string }) {
  ...
  useEffect(() => {
    async function fetchResource() {
      setLoading(true);
      setError(null);
      // Ambil id kategori presentations
  ...
  return (
    <div className="max-w-3xl mx-auto py-16 px-4">
      <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Presentations", href: "/?tab=presentations#resource-section" }, { label: resource.title }]} />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": `https://freebieskit.com/resource/presentations/${resource.id}`,
            "author": {
              "@type": "Organization",
              "name": "Freebieskit"
            }
