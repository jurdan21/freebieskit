...
export default function DetailTemplates({ id }: { id: string }) {
  ...
  return (
    <div className="max-w-3xl mx-auto py-16 px-4">
      <Breadcrumbs items={[{ label: "Home", href: "/" }, { label: "Templates", href: "/?tab=templates#resource-section" }, { label: resource.title }]} />
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "url": `https://freebieskit.com/resource/templates/${resource.id}`,
            "author": {
              "@type": "Organization",
              "name": "Freebieskit"
            }
      ...
      <a href={resource.download_link} target="_blank" rel="noopener noreferrer" className="inline-block px-5 sm:px-6 py-2 rounded-full bg-blue-600 text-white font-medium shadow hover:bg-blue-700 transition text-sm sm:text-base">Download Now</a>
    </div>
  );
} 